...
<form id="frm-asignatura" action="?c=Asignatura&a=Guardar" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" name="Asignatura" value="<?php echo $asig->Asignatura; ?>" class="form-control" placeholder="Ingrese nombre de la asignatura"
            data-validacion-tipo="requerido|min:3" />
    </div>

    <div class="form-group">
        <label>Unidades Valorativas</label>
        <input type="text" name="UV" value="<?php echo $asig->UV; ?>" class="form-control" placeholder="Ingrese unidades valorativas"
